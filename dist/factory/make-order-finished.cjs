...
var make_order_finished_exports = {};
__export(make_order_finished_exports, {
  makeOrderFinished: () => makeOrderFinished
});
module.exports = __toCommonJS(make_order_finished_exports);
