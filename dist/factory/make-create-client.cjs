...
var make_create_client_exports = {};
__export(make_create_client_exports, {
  makeCreateClient: () => makeCreateClient
});
module.exports = __toCommonJS(make_create_client_exports);
