...
var make_authenticate_user_exports = {};
__export(make_authenticate_user_exports, {
  makeAuthenticateUser: () => makeAuthenticateUser
});
module.exports = __toCommonJS(make_authenticate_user_exports);
