...
`);
    ...
    var N = /* @__PURE__ */ function() {
      ...
      return function(n, i, o, s, a, l) {
        var u, c, p, d, f, g, h, O, T, S, C, E, me, ae, $t, U, ne, Se, z4, pt, kr = n.constructor, Ln = n.s == i.s ? 1 : -1, Y = n.d, _ = i.d;
        if (!Y || !Y[0] || !_ || !_[0]) return new kr(!n.s || !i.s || (Y ? _ && Y[0] == _[0] : !_) ? NaN : Y && Y[0] == 0 || !_ ? Ln * 0 : Ln / 0);
        for (l ? (f = 1, c = n.e - i.e) : (l = ge, f = b, c = ee(n.e / f) - ee(i.e / f)), z4 = _.length, ne = Y.length, T = new kr(Ln), S = T.d = [], p = 0; _[p] == (Y[p] || 0); p++) ;
        if (_[p] > (Y[p] || 0) && c--, o == null ? (ae = o = kr.precision, s = kr.rounding) : a ? ae = o + (n.e - i.e) + 1 : ae = o, ae < 0) S.push(1), g = true;
        else {
          if (ae = ae / f + 2 | 0, p = 0, z4 == 1) {
            for (d = 0, _ = _[0], ae++; (p < ne || d) && ae--; p++) $t = d * l + (Y[p] || 0), S[p] = $t / _ | 0, d = $t % _ | 0;
            g = d || p < ne;
          } else {
            for (d = l / (_[0] + 1) | 0, d > 1 && (_ = e(_, d, l), Y = e(Y, d, l), z4 = _.length, ne = Y.length), U = z4, C = Y.slice(0, z4), E = C.length; E < z4; ) C[E++] = 0;
            pt = _.slice(), pt.unshift(0), Se = _[0], _[1] >= l / 2 && ++Se;
            do
              d = 0, u = t(_, C, z4, E), u < 0 ? (me = C[0], z4 != E && (me = me * l + (C[1] || 0)), d = me / Se | 0, d > 1 ? (d >= l && (d = l - 1), h = e(_, d, l), O = h.length, E = C.length, u = t(h, C, O, E), u == 1 && (d--, r(h, z4 < O ? pt : _, O, l))) : (d == 0 && (u = d = 1), h = _.slice()), O = h.length, O < E && h.unshift(0), r(C, h, E, l), u == -1 && (E = C.length, u = t(_, C, z4, E), u < 1 && (d++, r(C, z4 < E ? pt : _, E, l))), E = C.length) : u === 0 && (d++, C = [0]), S[p++] = d, u && C[0] ? C[E++] = Y[U] || 0 : (C = [Y[U]], E = 1);
      ...
      for (let h in r) {
        ...
        for (let T = 0; T < O.length; ++T) {
          ...
          for (let U = n, ne = i; U < t.length; ne += t[U].length, ++U) {
            ...
            let z4 = [U, u];
            f && (++U, ne += f.length, z4.push(f));
            let pt = new he(h, C ? P.tokenize(p, C) : p, $t, p, me);
            if (z4.push(pt), g && z4.push(g), Array.prototype.splice.apply(t, z4), u != 1 && P.matchGrammar(e, t, r, U, ne, true, h), o) break;
          }
        }
      }
