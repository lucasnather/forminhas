...
`);
    ...
    var N = /* @__PURE__ */ function() {
      ...
      return function(n, i, o, s, a, l) {
        var u, c, p, d, f, g, h, O, T, S, C, E, me, ae, $t, U, ne, Se, z6, pt, kr = n.constructor, Ln = n.s == i.s ? 1 : -1, Y = n.d, _ = i.d;
        if (!Y || !Y[0] || !_ || !_[0]) return new kr(!n.s || !i.s || (Y ? _ && Y[0] == _[0] : !_) ? NaN : Y && Y[0] == 0 || !_ ? Ln * 0 : Ln / 0);
        for (l ? (f = 1, c = n.e - i.e) : (l = ge, f = b, c = ee(n.e / f) - ee(i.e / f)), z6 = _.length, ne = Y.length, T = new kr(Ln), S = T.d = [], p = 0; _[p] == (Y[p] || 0); p++) ;
        if (_[p] > (Y[p] || 0) && c--, o == null ? (ae = o = kr.precision, s = kr.rounding) : a ? ae = o + (n.e - i.e) + 1 : ae = o, ae < 0) S.push(1), g = true;
        else {
          if (ae = ae / f + 2 | 0, p = 0, z6 == 1) {
            for (d = 0, _ = _[0], ae++; (p < ne || d) && ae--; p++) $t = d * l + (Y[p] || 0), S[p] = $t / _ | 0, d = $t % _ | 0;
            g = d || p < ne;
          } else {
            for (d = l / (_[0] + 1) | 0, d > 1 && (_ = e(_, d, l), Y = e(Y, d, l), z6 = _.length, ne = Y.length), U = z6, C = Y.slice(0, z6), E = C.length; E < z6; ) C[E++] = 0;
            pt = _.slice(), pt.unshift(0), Se = _[0], _[1] >= l / 2 && ++Se;
            do
              d = 0, u = t(_, C, z6, E), u < 0 ? (me = C[0], z6 != E && (me = me * l + (C[1] || 0)), d = me / Se | 0, d > 1 ? (d >= l && (d = l - 1), h = e(_, d, l), O = h.length, E = C.length, u = t(h, C, O, E), u == 1 && (d--, r(h, z6 < O ? pt : _, O, l))) : (d == 0 && (u = d = 1), h = _.slice()), O = h.length, O < E && h.unshift(0), r(C, h, E, l), u == -1 && (E = C.length, u = t(_, C, z6, E), u < 1 && (d++, r(C, z6 < E ? pt : _, E, l))), E = C.length) : u === 0 && (d++, C = [0]), S[p++] = d, u && C[0] ? C[E++] = Y[U] || 0 : (C = [Y[U]], E = 1);
      ...
      for (let h in r) {
        ...
        for (let T = 0; T < O.length; ++T) {
          ...
          for (let U = n, ne = i; U < t.length; ne += t[U].length, ++U) {
            ...
            let z6 = [U, u];
            f && (++U, ne += f.length, z6.push(f));
            let pt = new he(h, C ? P.tokenize(p, C) : p, $t, p, me);
            if (z6.push(pt), g && z6.push(g), Array.prototype.splice.apply(t, z6), u != 1 && P.matchGrammar(e, t, r, U, ne, true, h), o) break;
          }
        }
      }
...
var order_route_exports = {};
__export(order_route_exports, {
  orderRoute: () => orderRoute
});
module.exports = __toCommonJS(order_route_exports);
...
// src/controller/orders/CreateOrderController.ts
var createOrderBodySchema = import_zod.z.object({
  moldsId: import_zod.z.array(import_zod.z.number())
});
var createOrderParamSchema = import_zod.z.object({
...
// src/controller/orders/FindManyOrdersController.ts
var findManyOrderQuerySchema = import_zod3.z.object({
  page: import_zod3.z.coerce.number().optional().default(0),
  wasFinished: import_zod3.z.coerce.boolean().optional(),
  wasPaid: import_zod3.z.coerce.boolean().optional()
});
...
// src/controller/orders/MarkOrderAsFinishedController.ts
var markOrderFinishedParamSchema = import_zod4.z.object({
  orderId: import_zod4.z.string().uuid(),
  clientName: import_zod4.z.string()
});
...
// src/controller/orders/MarkOrderAsPaidController.ts
var markOrderPaidParamSchema = import_zod5.z.object({
  orderId: import_zod5.z.string().uuid(),
  clientName: import_zod5.z.string()
});
...
router.post("/api/orders/:clientId", jwtVerify, async (req, res) => createOrderController.create(req, res)).get("/api/orders", jwtVerify, async (req, res) => findManyOrdersController.findMany(req, res)).get("/api/orders/:orderId/finished/:clientName", jwtVerify, async (req, res) => markOrderAsFinishedController.mark(req, res)).get("/api/orders/:orderId/paid/:clientName", jwtVerify, async (req, res) => markOrderAsPaidController.mark(req, res));
var orderRoute = router;
