...
var mold_route_exports = {};
__export(mold_route_exports, {
  moldRoute: () => moldRoute
});
module.exports = __toCommonJS(mold_route_exports);
...
router.post("/api/molds", jwtVerify, async (req, res) => createMoldController.create(req, res));
var moldRoute = router;
