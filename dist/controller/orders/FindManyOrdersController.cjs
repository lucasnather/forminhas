...
var FindManyOrdersController_exports = {};
__export(FindManyOrdersController_exports, {
  FindManyOrderController: () => FindManyOrderController
});
module.exports = __toCommonJS(FindManyOrdersController_exports);
...
// src/controller/orders/FindManyOrdersController.ts
var findManyOrderQuerySchema = import_zod.z.object({
  page: import_zod.z.coerce.number().optional().default(0),
  wasFinished: import_zod.z.coerce.boolean().optional(),
  wasPaid: import_zod.z.coerce.boolean().optional()
});
