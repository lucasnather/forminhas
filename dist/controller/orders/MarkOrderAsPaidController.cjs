...
var MarkOrderAsPaidController_exports = {};
__export(MarkOrderAsPaidController_exports, {
  MarkOrderAsPaidController: () => MarkOrderAsPaidController
});
module.exports = __toCommonJS(MarkOrderAsPaidController_exports);
...
// src/controller/orders/MarkOrderAsPaidController.ts
var markOrderPaidParamSchema = import_zod.z.object({
