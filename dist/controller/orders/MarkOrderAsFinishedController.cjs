...
var MarkOrderAsFinishedController_exports = {};
__export(MarkOrderAsFinishedController_exports, {
  MarkOrderAsFinishedController: () => MarkOrderAsFinishedController
});
module.exports = __toCommonJS(MarkOrderAsFinishedController_exports);
...
// src/controller/orders/MarkOrderAsFinishedController.ts
var markOrderFinishedParamSchema = import_zod.z.object({
  orderId: import_zod.z.string().uuid(),
  clientName: import_zod.z.string()
});
